...
type SessionStartNonUniqueIdPasses struct{
	retries int
}


func NewSessionStartNonUniqueIdPasses() *SessionStartNonUniqueIdPasses{
	ssnuip := &SessionStartNonUniqueIdPasses{retries:0}
	return ssnuip
}
